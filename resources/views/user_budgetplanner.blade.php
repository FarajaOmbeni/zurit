                                            ...
                                            <div class="modal-body">
                                                <form action="{{ route('storeExpense') }}" method="post">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number"
                                                            name="expense[Savings][expected_expense]"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number"
                                                            ...
                                                            placeholder="Expected Expense">
                                                        <input type="number"
                                                            name="expense[Investments][actual_expense]"
                                                            placeholder="Actual Expense">
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number"
                                                            name="expense[Transport][expected_expense]"
                                                            placeholder="Expected Expense">
                                                        <input type="number"
                                                            name="expense[Transport][actual_expense]"
                                                            placeholder="Actual Expense">
                                                    </div>
                                                    <div class="form-group">
