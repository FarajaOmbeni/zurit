        ...
        <div id="content">
            <div class="d-flex toggled" id="wrapper">
                ...
                <nav id="sidebar" class="img" style="background-image: url(admin_res/images/bg_1.jpg);">
                    <div class="p-4">
                        <a href="index.html"><img class="logo" src="{{ asset('admin_res/images/logo-white3.png') }}"
                                alt=""></a><span><br>Admin Dashboard</span>
                        <ul class="list-unstyled components mb-5 flex-container">
                            ...
                            <li class="{{ Request::is('blogs_admindash') ? 'active' : '' }}">
                                <a href="{{ url('/blogs_admindash') }}"><span class="fa fa-user mr-3"></span> Blogs
                                    Management</a>
                            </li>
                            <li class="{{ Request::is('books_admindash') ? 'active' : '' }}">
                                <a href="{{ url('/books_admindash') }}"><span class="fa fa-book mr-3"></span> Books
                                    Management</a>
                            </li>
                            <li class="{{ Request::is('events_admindash') ? 'active' : '' }}">
                                <a href="{{ url('/events_admindash') }}"><span class="fa fa-money mr-3"></span> Events
                                    Management</a>
                            </li>
                            <li class="{{ Request::is('insights_admindash') ? 'active' : '' }}">
                                <a href="{{ url('/insights_admindash') }}"><span class="fa fa-sticky-note mr-3"></span>
                                    System Insights</a>
                            </li>
                            <li class="{{ Request::is('contacts_admindash') ? 'active' : '' }}">
                                <a href="{{ url('/contacts_admindash') }}"><span class="fa fa-phone mr-3"></span>
                                    Contacts Dash</a>
                            </li>
