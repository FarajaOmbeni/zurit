<html>
    ...
    <div class="container d-flex align-items-stretch">
        ...
        <nav id="sidebar" class="img" style="background-image: url(admin_res/images/bg_1.jpg);">
            <div class="p-4">
                <a href="index.html"><img class="logo" src="admin_res/images/logo-white3.png"
                        alt=""></a><span><br>Editor Dashboard</span>
                <ul class="list-unstyled components mb-5 flex-container">
                    <li class="active">
                        <a href="{{ url('/blogs_editordash') }}"><span class="fa fa-user mr-3"></span> Blogs
                            Management</a>
                    </li>
                    <li>
                        <a href="{{ url('/books_editordash') }}"><span class="fa fa-book mr-3"></span> Books
                            Management</a>
                    </li>
                    <li>
