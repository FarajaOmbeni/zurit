...
<html lang="en">
    ...
    <head>
        ...
        <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.0/dist/js/bootstrap.bundle.min.js"
            integrity="sha384-U1DAWAznB1U5Y0Uc6J0JpY4+Hc1c4b+D2tp9qUeJ6N7lN4y4gx5nU4w2f4Z+d5GDK6bj7f" crossorigin="anonymous">
        </script>
        <!-- PWA  -->
        ...
        <div class="container mainmargin">
                    ...
                    <div class="card book_card custom-card">
                        ...
                        <div class="card-footer text-center">
                            <button type="button" class="btn btn-primary open-modal" data-toggle="modal"
                                ...
                                data-description="{{ $book->description }}" data-price="{{ $book->current_price }}">
                                Get a Copy
                            </button>
                        </div>
                    </div>
            ...
            <div class="books-container">
                @foreach ($books as $book)
                    <div class="book-card">
                        <div class="card-body">
                            <div><img class="card-img-top card-img"
                                    src="{{ asset('books_res/img/' . $book->book_image) }}" alt="Card image cap"></div>
                    ...
                    <div class="col-md-6">
                        <div class="card-body" style="margin-top: 50px;">
                            ...
                            <div id="bookType" style="margin-top: 20px;">
                                <!-- Book type options can go here -->
                            </div>
                            <div>
                                After making the payment, contact Noelle Jentrix on 0713544255 to plan for delivery.
                            </div>
                            <div style="margin-top: 20px;">
                                <img src="{{ asset('books_res/img/mpesa.png') }}" alt="Lipa na M-Pesa details"
