    ...
    <section class="training_section">
        ...
        <div class="category_cards_container">
            <div class="category_card individual">
                <img src="{{ asset('training_res/img/prosperity.webp') }}" alt="">
            ...
            <img src="{{ asset('training_res/img/fundamentals.webp') }}" alt="">
                ...
                <p class="card_title">FUNDAMENTALS OF<span>INVESTMENTS</span></p>    
                    ...
                    <button class="brochure_btn" type="button" data-toggle="modal" data-target="#modal_fundamentals">Learn more</button>
                </div>
            ...
            <img src="{{ asset('training_res/img/retirement.webp') }}" alt="">
                ...
                <p class="card_title">RETIREMENT<span> <br>PLANNING</span></p>    
                    ...
                    <button class="brochure_btn" type="button" data-toggle="modal" data-target="#modal_retirement1">Learn more</button>
                </div>
            ...
            <img src="{{ asset('training_res/img/employee_wellness.webp') }}" alt="">
                ...
                <button class="brochure_btn" type="button" data-toggle="modal" data-target="#modal_wellness">Learn more</button>
                </div>
            ...
            <img src="{{ asset('training_res/img/retirement_pic.webp') }}" alt="">
                ...
                <button class="brochure_btn" type="button" data-toggle="modal" data-target="#modal_retirement2">Learn more</button>
                </div>
            ...
            <img src="{{ asset('training_res/img/wealth_wave.webp') }}" alt="">
                ...
                <p class="card_desc" style="margin-top:-20px;">Unlocking Your Wealth Potential,Securing Your Legacy.</p> 
                <button class="brochure_btn" type="button" data-toggle="modal" data-target="#modal_wealthWave">Learn more</button>
                </div>
            ...
            <img src="{{ asset('training_res/img/asset_class.webp') }}" alt="">
                ...
                <p class="card_desc" style="margin-top:-20px;">Empowering Financial Literacy, Diversifying Portfolios.</p> 
                <button class="brochure_btn" type="button" data-toggle="modal" data-target="#modal_assetClass">Learn more</button>
                </div>
        ...
        <div class="modal fade" id="modal_prosperity" tabindex="-1" role="dialog" aria-labelledby="modal_prosperity" aria-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <a href="#" class="btn btn-primary btn-enroll" data-toggle="modal" data-target="#modal_enroll">Enroll</a>
        ...
        <!-- Fundamentals Modal -->
        <div class="modal fade" id="modal_fundamentals" tabindex="-1" role="dialog" aria-labelledby="modal_fundamentals" aria-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
              ...
              <p>This is a  <span class="gold_text">3-day</span>intense training for
                ...
                them on the fundamentals of investments<br><p>
              ...
              <a href="#" class="btn btn-primary btn-enroll" data-toggle="modal" data-target="#modal_enroll">Enroll</a>
                ...
                <!-- Retirement1 Modal -->
                <div class="modal fade" id="modal_retirement1" tabindex="-1" role="dialog" aria-labelledby="modal_retirement1" aria-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
              ...
              <div class="modal-body"> 
              <p>Immerse yourself in this comprehensive training designed for pension trustees. The course provides a deep dive into retirement planning strategies, 
              helping trustees understand the complexities of retirement income management and long-term investment planning.<br><p>
           ...
           <!-- Wellness Modal -->
           <div class="modal fade" id="modal_wellness" tabindex="-1" role="dialog" aria-labelledby="modal_wellness" aria-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
              ...
              <div class="modal-body"> 
              <p>Dive into our Employee Wellness Program, a holistic initiative designed to promote and improve the health and well-being of your workforce. This program focuses on a variety of wellness aspects, including physical health, 
                mental well-being, and work-life balance, aiming to create a healthier, happier, and more productive workplace.<br><p>
              ...
              <span style="font-size:20px;"><b>Price:</b> Kshs 5,000 per person OR Kshs 45,000(group of 10)<br></span>
              <span style="font-size:20px;"><b>Duration:</b> ..<br></span>
              </div>
              <div class="modal-footer">
              <a href="#" class="btn btn-primary btn-enroll" data-toggle="modal" data-target="#modal_enroll">Enroll</a>
        ...
        <!-- retirement2 Modal -->
        <div class="modal fade" id="modal_retirement2" tabindex="-1" role="dialog" aria-labelledby="modal_retirement2" aria-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
              ...
              <div class="modal-body"> 
              <p>Explore our Corporate Retirement Planning program, a comprehensive course designed to equip businesses with the knowledge and tools to establish and manage effective retirement plans. This program focuses on understanding the intricacies of retirement planning, including investment strategies, risk management, 
                and regulatory compliance, with the goal of ensuring a secure and stable retirement for employees.<br><p>
        ...
        <!-- wealth_wave Modal -->
        <div class="modal fade" id="modal_wealthWave" tabindex="-1" role="dialog" aria-labelledby="modal_wealthWave" aria-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
              ...
              <div class="modal-body"> 
              <p>Join our Wealth Wave Talks program to learn essential wealth creation and preservation strategies. 
                This program offers insights into smooth wealth transfer to future generations and includes comprehensive training on wealth building and estate planning.<br><p>
              ...
              <p>This program is ideal for individuals seeking to enhance their financial literacy, wealth creation and preservation strategies.</p>

              <span style="font-size:20px;"><b>Price:</b>Kshs 1500<br></span>
              <span style="font-size:20px;"><b>Conducted Through Virtual sessions:</b> Enter Contact details for more info <br></span>
              </div>
              <div class="modal-footer">
              <a href="#" class="btn btn-primary btn-enroll" data-toggle="modal" data-target="#modal_enroll">Join</a>
                <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
              </div>
            </div>
          </div>
        ...
        <!-- Bi-weekly Modal -->
        <div class="modal fade" id="modal_assetClass" tabindex="-1" role="dialog" aria-labelledby="modal_assetClass" aria-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
              ...
              <div class="modal-body"> 
              <p>Our Asset Classes Training is a specialized program aimed at improving financial literacy and aiding in informed investment decisions. It's suitable for both seasoned investors and beginners, 
                providing the necessary knowledge to effectively navigate the complex world of asset classes.<br><p>
              ...
              <p><b>Who is it for?</b></p>
              <p>This program is a golden opportunity for everyone! Whether you're a seasoned investor, a beginner, or simply someone curious about the financial world</p>
              ...
              <a href="#" class="btn btn-primary btn-enroll" data-toggle="modal" data-target="#modal_enroll">Join</a>
                ...
                <!-- Podcast Modal -->
                <div class="modal fade" id="modal_podcast" tabindex="-1" role="dialog" aria-labelledby="modal_podcast_label" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-body"> 
          <p>Join our podcast to gain insights into the world of finance and investment. Whether you're a seasoned investor or just starting your financial journey, our podcast offers valuable knowledge for everyone.<br><p>
          ...
          <p>Our podcast is tailored especially for the youth, providing accessible and engaging discussions on key financial topics to empower them with the knowledge they need to thrive in today's economy.</p>
      ...
      <a href="https://www.youtube.com/playlist?list=PLxcZQqn1KJeaceh8cA3CA-noho19CIXeJ" class="btn btn-primary" target="_blank">Visit Channel</a>
        ...
        <!-- enroll modal -->
        <div class="modal fade" id="modal_enroll" tabindex="-1" role="dialog" aria-labelledby="modal_enroll" aria-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content" style= "padding:3%; background-color:#0c2533;">
              ...
              <div class="modal-body">
                <form id="enrollForm">
                  ...
                  <p> All fields marked with <span style="color:red; font-size:20px;">*</span> are required</p>
