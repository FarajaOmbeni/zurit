...
<html>
    ...
    <body>
        <div class="email-container">
            ...
            <p><b>{{ $name }}</b></p>
            <hr>
            <p><b>Question: </b>Please rate the overall organization and logistics of the training sessions (e.g.,
                venue, scheduling, facilities).</p>
            <p><b>Answer: </b>{{ $venue }}/5</p>
            <hr>
            <p><b>Question: </b>How satisfied are you with the clarity and comprehensiveness of the topics covered
            ...
            <hr>
            <p><b>Question: </b>How likely are you to attend other Zurit Consulting's trainings based on your
                experience?
            </p>
            ...
            <hr>
            <p><b>Question: </b>Are there any additional topics or areas of interest you would like to see covered in
