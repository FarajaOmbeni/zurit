...
<body>
    <div class="email-container">
        ...
        <p><b>{{$name}}</b></p>
        <hr>
        <p><b>Question: </b>Please rate the overall organization and logistics of the training sessions (e.g., venue, scheduling, facilities).</p>
        <p><b>Answer: </b>{{ $venue }}/5</p>
        <hr>
        <p><b>Question: </b>How satisfied are you with the clarity and comprehensiveness of the topics covered during the training sessions?</p>
        ...
        <hr>
        <p><b>Question: </b>Please rate the value for money of the financial training and services provided by Zurit Consulting.
</p>
        ...
        <hr>
        <p><b>Question: </b>Are there any additional topics or areas of interest you would like to see covered in future training sessions?
</p>
        <p><b>Answer: </b>{{ $suggestion }}</p>
        <hr>
        <p><b>Question: </b>Do you have any suggestions or ideas for how we can enhance the overall customer experience during our training sessions?
</p>
        <p><b>Answer: </b>{{ $improve_experience }}</p>
        <hr>
        <p><b>Question: </b>Who was your favourite trainor/trainors?
</p>
        <p><b>Answer: </b>{{ $fav_trainor }}</p>
        <hr>
        <p><b>Question: </b>Kindly tell us what you think about our trainings in general
</p>
        <p><b>Answer: </b>{{ $testimonial }}</p>
