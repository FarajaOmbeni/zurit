                    ...
                    <div class="offcanvas-body">
                        ...
                        <div class="nav-menu">
                            ...
                            <div class="dropdown-title">
                                ...
                                <img class="arrow-icon" src="{{ asset('home_res/img/icon/arrow.png') }}"
                                    alt="">
                            </div>
                            <ul>
                ...
                <div class="container">
                    ...
                    <div class="contact-content d-flex flex-column flex-lg-row">
                        ...
                        <div class="map mb-4 mb-lg-0">
                            <a href="https://maps.app.goo.gl/awNjntYupy6x7SNz5" target="_blank"><img
                                    class="map_image" src="{{ asset('home_res/img/map.webp') }}" alt=""></a>
                        </div>
