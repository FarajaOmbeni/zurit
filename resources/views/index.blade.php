        ...
        <div class="container">
          <div class="header row py-md-5">
            <div class="header-text col-md-6">
              ...
              <a class="btn btn-light header-btn">Learn More <img src="img/arrow-right.svg" alt="" style="width:20px"></a>
            </div>
            <div class="col-md-6">
              <!-- Video Container -->
    ...
    <div class="upcoming-trainings">
      @foreach($events as $event)
        <div class="upcoming-training-card-center">
          ...
          <div class="reglink-container"><a href="{{ $event->registration_link }}" class="registration-link" target="_blank">REGISTER NOW</a></div>
        </div>
        @endforeach               
    </div>
  ...
  <div class="container">
    ...
    <div class="contact-content d-flex flex-column flex-lg-row">
      <div class="map mb-4 mb-lg-0">
        <!-- Embed your map here -->
        <iframe src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3988.7744044269725!2d36.801995999999995!3d-1.3107!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMcKwMTgnMzguNSJTIDM2wrA0OCcwNy4yIkU!5e0!3m2!1sen!2ske!4v1707382631263!5m2!1sen!2ske" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
      </div>
              ...
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <div class="testimonial">
                    <div class="client">
                      <div class="photo"><img style="height: 90%; width: 90%;" src="img/Davis.webp" alt=""></div>
                ...
                <div class="carousel-item">
                  <div class="testimonial">
                    <div class="client">
                      <div class="photo"><img style="height: 90%; width: 90%;" src="img/Bramwel.webp" alt=""></div>
