        ...
        <div class="container mainmargin">
            <div class="row">
                <div class="main col-md-8">
                    ...
                    <p class="text-gray">
                        At Zurit Financial Consulting, we have a rich history of helping individuals and businesses
                        achieve
                        their financial goals. Our journey began with a vision to provide tailored financial solutions,
                        and
                    ...
                    <p class="text-gray">
                        ...
                        meet your unique financial challenges. Our commitment to your financial prosperity drives us to
                        work
                    ...
                    <div class="team-wrapper text-center">
                        ...
                        <div class="team">
                            ...
                            <div class="team-item">
                                <div class="photo"><img class="uniform-img" src="about_res/img/Davis.webp"
                                        alt="Davis Otao" style="width: 100%; height: auto;"></div>
                ...
                <div class="input-group-append">
                    ...
                    <div class="recent-post">
                        <h4>Who We Are</h4>
                        <p>
                            We are a bespoke Wealth Management Company focused on both individuals and corporates
                            looking at
                        ...
                        <h4>Mission</h4>
                        <p>
                            Deliver simple efficient Financial Trainings and Advisory Solutions which form the
                            cornerstone
                    ...
                    <div class="sidebar-benefits-items pt-5">
                        ...
                        <div class="sidebar-benefits-item">
                            ...
                            <div class="text-gray">
                                <p>
                                    Our Debt Manager tool provides a comprehensive solution to track, organize, and
                                    optimize
                        ...
                        <div class="sidebar-benefits-item">
                            <div class="sidebar-benefits-item-title d-flex">
                                <div class="icon"><img src="about_res/img/invest.webp"
                                        alt="Investment Planner Icon"></div>
                        ...
                        <div class="sidebar-benefits-item">
                            <div class="sidebar-benefits-item-title d-flex">
                                <div class="icon"><img src="about_res/img/budget.webp" alt="Budget Planner Icon">
                                </div>
