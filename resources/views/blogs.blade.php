                ...
                <div class="col-lg-8 col-lg-offset-2">
                    <div class="card card-custom">
                        ...
                        <div class="card-body card-body-custom">
                            ...
                            <p class="lorem_text">{{ \Illuminate\Support\Str::limit(strip_tags(html_entity_decode($blog->blog_message)), 400, $end='...') }}</p>
                            ...
                            <div class="read_bt">
                            <a href="{{ route('blog.view', ['id' => $blog->id, 'title' => \Illuminate\Support\Str::slug($blog->blog_title)]) }}">Read More</a>
                            </div>
                            </div>
                        </div>
                    </div>
