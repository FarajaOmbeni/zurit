        ...
        <div class="main">
            <section id="what-is-budget-planner">
                <div class="content">
                    ...
                    <p class="text-gray">
                        A Net Worth Calculator is a financial tool that evaluates an individual's wealth by subtracting
            ...
            <section id="budget-planning-made-simple">
                ...
                <p class="text-gray">
                    At Zurit, we believe in simplifying the process of calculating your net worth. Our tool is designed
