                                            ...
                                            <div class="">
                                                ...
                                                <select name="investment[investment_type]" id="investmentType"
                                                    ...
                                                    @foreach ($withholdingTaxRates as $rate)
                                                        <option value="{{ $rate->id }}">{{ $rate->investment_type }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
                        ...
                        <div>
                            ...
                            <div class="card mt-4"
                                ...
                                <div class="card-body text-white">
                                    ...
                                    <p class="card-text">Net Interest:
                                        {{ $monthlyInvestments[0][$currentMonth]['net_interest'] ?? 'N/A' }}</p>
                                    <p class="card-text">Cumulative Investment Value:
                                        {{ $monthlyInvestments[0][$currentMonth]['cumulative_investment_value'] ?? 'N/A' }}
                                    </p>
                                </div>
                            </div>
